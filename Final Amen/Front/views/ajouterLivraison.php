...
$listeClient=$transporteurC->recupererClientParMail($_SESSION['l']);
foreach($listeClient as $sesrow){
}
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    ...
                    <form method="POST" action="ajoutLivraison.php" onsubmit="return verifForm5(this)">
                            ...
                            <tr>
                              <td>Destination</td>
                              <td><select onblur="verifDest(this)" class="form-control form-control-user"  width="30%"  size="1" name="dest" id="gouv" onblur="verifSelection(this)">
                    ...
                    <span class="icon text-white-50">
                      <input type="submit" name="ajouter"><i class="far fa-save"></i>
                          ...
                          <tr>
                            ...
                            <td>
														<input type="text" class="form-control form-control-user" width="30%" placeholder="Saisir l'ID du trnasporteur"
                                  name="cinClient" value="<?php echo $sesrow['cin']; ?>" onblur="verifIDTransporteur(this)" readonly>
                          ...
                          <tr>
                            <td>Code de la commande</td>
                              ...
                              <td>
														<input type="text" name="idCommande" class="form-control form-control-user" value="<?php echo $_GET['idCommande'];?>" width="30%"  size="1"  onblur="verifSelection(this)" readonly>
