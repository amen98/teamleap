		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					...
					<form>
					<h4>Les information de votre livraison </h4><br><br>
...
$result=$transporteurC->recupererTransporteur2($_GET['idTransp']);
...
?>
	...
	<p><b><font size=3px>Nom et Prenom: </font></b><?PHP echo $nom.' '.$prenom; ?></p>
    <p><b><font size=3px>Numéro de télephone: </font></b><?PHP echo $tel; ?></p>
	<p><b><font size=3px>Adresse mail: </font></b><?PHP echo $mail; ?></p>
	<hr>
<a href="AfficherLivraisonDetails.php?idCommande=<?php echo $_GET['idCommande'];?>">Retour</a>
