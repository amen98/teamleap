...
?>
<form method="POST"  onsubmit="return verifForm5(this)">
<table>
<tr>
<td>Numéro de la livraison</td>
<td><input type="text" name="dateL" value="<?PHP echo $num ?>" class="form-control form-control-user"  width="30%" disabled></td>
</tr>
<tr>
...
<tr>
<td></td>
<td><br><input type="submit" name="modifier" value="modifier" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"></td>
<br>

<tr>
<td></td>
<td></td>
<td><a href="AfficherLivraisonDetails.php?idCommande=<?php echo $idCommande;?>">Retour</a></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
  $result=$transporteurC->recupererTransporteur2($_POST['idTransporteur']);
	...
	$livraison= new Livraison($_POST['dateL'],$_POST['dest'],$_POST['adr'],$total,$cinClient,$idCommande,$_POST['idTransporteur']);
...
$livraison1C=new LivraisonC();
	...
	$result3=$livraisonC->recupererLivraison($_GET['num']);
	...
	foreach($result3 as $row){
		...
		foreach($result2 as $row1){
				...
				$to=$row1['mail'];
	$sujet='Modification du livraison';
	$text='Bonjour Mr/Mm '.$row1['nom'].' Votre demmande de modification du livraison est effectué avec succès';
