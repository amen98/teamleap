...
<i class="fas fa-shipping-fast"></i>
       ...
       <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="afficherTransporteur.php">Gérer les transporteur</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="livraison-Ajout.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>  Ajouter un livraison</a></div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
            ...
            <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">GÉRER LES LIVRAISONS </h6>
                </div>
                <div class="card-body">
...
$listeLivraisons=$livraison1C->afficherLivraisonsTerminer();
...
foreach($listeLivraisons as $row){
  ...
  <td><?PHP echo $row['frais'].' Dinars'; ?></td>
	...
	<button type="submit" name="supprimer" value="supprimer" style="background-color: transparent;border: 0px"><i class="fas fa-trash-alt"></i></button>
	<input type="hidden" value="<?PHP echo $row['num']; ?>" name="num1">
	</form>
	</td>
	<td><a href="modifierLivraison.php?num=<?PHP echo $row['num']; ?>"><i class="fas fa-pen" style="color:black"></i>
	</a></td>
	</tr>
	</tbody>
	<?PHP
