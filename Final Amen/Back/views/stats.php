            ...
            <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Les livraison les plus proche </h6>
                </div>
                <div class="card-body">
...
?>
<form method="POST">
<table id="dataTable2" width="50%" cellspacing="0">
  <tr>
<td>Date de livraison</td>
                              ...
                              <td>
                              <input type="submit" name="confirmer" value="CONFIRMER" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                              </td>
</tr>
</table>
</form>
...
$listeLivraisons1=$livraison1C->afficherLivraisonsParDate($_POST['date']);
...
<?PHP
foreach($listeLivraisons1 as $row){
  ...
  <td><?PHP echo $row['frais'].' Dinars'; ?></td>
...
$s=0;
$listeLivraisons2=$livraison1C->afficherLivraisons();
foreach($listeLivraisons2 as $row){
  $s++;
}
$sCours=0;
$listeLivraisons3=$livraison1C->affichernbEnCoursLivraisons();
foreach($listeLivraisons3 as $row){
  $sCours++;
}
?>
</table>
  ...
  <div class="card border-left-primary shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Nombre de livraison</div>
...
?>
<!-- Earnings (Monthly) Card Example --><?php $p1=($sCours/$s)*100;
$p2=(($s-$sCours)/$s)*100;
      ?>
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-success shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Nombre livraison terminé</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo "$sCours"; ?>
          <h6 class="small ">Pourcentage<span class="float-right"><?php $p1=round($p1);echo $p1; ?>%</span></h6>

                  <div class="progress mb-4">
                    <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo "$p1"?>%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
      </div>
      
      
                  <a href="afficherLivraisonTerminer.php">Afficher la liste</a>
        </div>
        <div class="col-auto">
        </div>
      </div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-info shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Nombre livraison en cours</div>
          <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $s-$sCours; ?>
          <h6 class="small ">Pourcentage<span class="float-right"><?php $p2=round($p2);echo "$p2"; ?>%</span></h6>

                  <div class="progress mb-4">
                    <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo "$p2"?>%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
      </div>
      
      
                  <a href="afficherLivraisonEnCours.php">Afficher la liste</a>
        </div>
        <div class="col-auto">
        </div>
      </div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-warning shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Meilleur destination</div>
          <?php
          $listeLivraisons4=$livraison1C->afficherDestPlus();
          
          foreach($listeLivraisons4 as $row4){
            
           ?>
          
          <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row4['Destination'];?></div>
          <?php
        }
          ?>
        </div>
