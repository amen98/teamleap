...
if (isset($_GET['cin'])){
    ...
    $id=$row['id'];
		...
		$mail=$row['mail'];
		$typeV=$row['typeV'];
    $nbPaquet=$row['nbPaquet'];
    $montant=$row['montant'];
?>
<form method="POST" onsubmit="return verifForm3(this)">
<table>
<tr>
<td>ID</td>
<td><input type="number" name="id" value="<?PHP echo $id ?>" class="form-control form-control-user"  width="30%" disabled></td>
</tr>
<tr>
<td>CIN</td>
<td><input type="number" name="cin1" value="<?PHP echo $cin ?>" class="form-control form-control-user"  width="30%" disabled></td>
</tr>
<tr>
<td>Nom</td>
<td><input onblur="verifNom(this)" type="text" name="nom" value="<?PHP echo $nom ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Prenom</td>
<td><input onblur="verifPrenom(this)" type="text" name="prenom" value="<?PHP echo $prenom ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Numéro de téléphone</td>
<td><input onblur="verifTel(this)" type="number" name="tel" value="<?PHP echo $tel ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Adresse mail</td>
<td><input  onblur="verifMail(this)" type="text" name="mail" value="<?PHP echo $mail ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td>Type de véhicule</td>
<td><select onblur="verifType(this)" class="form-control form-control-user"  width="30%"  size="1" id="type" name="typeV" >
...
<tr>
<td>Coefficient de frais</td>
<td><input type="number" step="0.1" min="1" max="10" name="montant" value="<?PHP echo $montant ?>" class="form-control form-control-user"  width="30%"></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
  if ($_POST['typeV']=="Moto"){
	...
	$transporteur=new Transporteur($_GET['cin'],$_POST['nom'],$_POST['prenom'],$_POST['tel'],$_POST['mail'],$_POST['typeV'],$nbMax,$_POST['montant']);
	$transporteurC->modifiertransporteur($transporteur,$_GET['cin']);
