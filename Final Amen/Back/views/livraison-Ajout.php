...
$listeCommande=$transporteurC->afficherCommande2();
?>
  <meta charset="utf-8">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">snt
          <sup>Dashboard</sup>
        </div>
      </a>
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="text-truncate">Am I a good boy? The reason I ask is because someone told me that people say this to all dogs, even if
                ...
                <div class="card-body">
                  <div class="card-body">
                    <div class="table-responsive">
                      <form method="POST" action="ajoutLivraison.php" onsubmit="return verifForm2(this)">
                        <table  width="60%" border="0px" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="date" class="form-control form-control-user" width="30%" placeholder="Saisir l'ID du trnasporteur"
                                  name="date" onblur="verifDate(this)">
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td>Destination</td>
                              <td><select class="form-control form-control-user"  width="30%"  size="1" name="dest" id="dest" onblur="verifDest(this)">
                            ...
                            <tr>
                                ...
                                <td>
                                  <input type="text" class="form-control form-control-user" width="30%" placeholder="Saisir l'adresse de la livraison'"
                                    name="adr" onblur="verifAdresse(this)">
                                </td>
                              </tr>
                    ...
                    <span class="icon text-white-50">
                      <input type="submit" name="ajouter"><i class="far fa-save"></i>
                          ...
                          <tr>
                            ...
                            <td>
                            <select  id="cinClient" name="cinClient" class="form-control form-control-user"  width="30%"  size="1"  onblur="verifCin2(this)">
	...
	<?PHP } ?>
                          ...
                          <tr>
                            <td>Code de la commande</td>
                              ...
                              <td>
                              <select name="idCommande" id="idCommande" class="form-control form-control-user"  width="30%"  size="1"  onblur="verifCommande2(this)">
...
foreach($listeCommande as $row){
	...
	<?PHP } ?>
                            ...
                            <td>
                            <select name="idTransporteur" id="idTransporteur" class="form-control form-control-user"  width="30%"  size="1"  onblur="verifTransp2(this)">
