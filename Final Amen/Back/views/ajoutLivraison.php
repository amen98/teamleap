...
$result2=$livraison1C->recupererClient($_POST['cinClient']);
	...
	$text='Bonjour Mr/Mm '.$row1['nom'].'. Une livraison a été affecté pour votre commande N°'.$_POST['idCommande'].' a '.$_POST['adr'].'-'.$_POST['dest'].' le '.$_POST['date'].' .Vous pouvez contacter le 27 925 666 pour plus d\'information.';
