      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="transp - Ajout.html" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>  Ajouter un transporteur</a></div>
          <!-- Content Row -->
          <!-- Content Row -->
          <div class="row">
            <!-- Area Chart -->
            ...
            <div class="container-fluid">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">GÉRER LES TRANSPORTEURS </h6>
                </div>
                <div class="card-body">
...
$listeTransporteurs=$transporteur1C->affichertransporteurs();
...
<table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          ...
                          <th>Nombre de paquet max</th>
                          <th>Coefficient de frais</th>
...
foreach($listeTransporteurs as $row){
  ...
  <td><?PHP echo $row['nbPaquet']; ?></td>
  <td><?PHP echo $row['montant']; ?></td>
	<td><form method="POST" action="supprimerTransporteur.php">
	...
	<td><a href="modifierTransporteur.php?cin=<?PHP echo $row['cin']; ?>"><i class="fas fa-pen" style="color:black"></i>
	</a></td>
	</tr>
	</tbody>
	<?PHP
